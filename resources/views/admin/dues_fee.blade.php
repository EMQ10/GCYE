               ...
               <tbody id="dynamic-row">
                   @foreach ($members as $member)
                       ...
                       <tr>
                           ...
                           @endif
                            @if ($member->reg_fee == 'Yes')
                            <td style="color: green">PAID</td>
                            @endif

                           @if($member->dues_fee == 'No')
                           <td> <button class="btn btn-danger">{{ $member->reg_fee }}</button> </td>
                            @else
                            <td> <button class="btn btn-success">{{ $member->reg_fee }}</button> </td>
                        @endif
                           <td>

                            @if($member->dues_fee == 'No')
                            <a class="btn btn-outline-primary"  href="{{ route('user.create',$member->mid) }}">Approve</a>
